...
// Kode untuk menampilkan data lama
                    ...
                    <form action="" method="POST">
                        <fieldset>
                            <div class="my-2 d-none">
                                ...
                                <input type="number" name="nim" id="nim" class="form-control" value="" required>
                            </div>
                            <div class="my-2">
                            ...
                            <div class="my-2">
                                ...
                                <input type="number" name="no_hp" id="no_hp" class="form-control" value="" required>
                            </div>
